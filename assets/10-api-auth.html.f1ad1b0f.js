...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="apiserver\u65B0\u589E\u57DF\u540D-ip" tabindex="-1"><a class="header-anchor" href="#apiserver\u65B0\u589E\u57DF\u540D-ip" aria-hidden="true">#</a> apiserver\u65B0\u589E\u57DF\u540D/ip</h2><p><strong>https\u9A8C\u8BC1\u4E3B\u8981\u8FC7\u7A0B</strong></p><ol><li>\u5BA2\u6237\u7AEF\u8BF7\u6C42\u670D\u52A1\u7AEF\uFF0C\u670D\u52A1\u7AEF\u8FD4\u56DE\u5BA2\u6237\u7AEF\u8BC1\u4E66\u6587\u4EF6\uFF08crt\uFF09</li><li>\u5BA2\u6237\u7AEF\u9A8C\u8BC1crt\u8BC1\u4E66\u627E\u5230\u672C\u5730\u7684ca\u6839\u8BC1\u4E66\uFF0C\u4E00\u822C\u6D4F\u89C8\u5668\u90FD\u4F1A\u5B89\u88C5\uFF08\u8FD9\u4E2A\u8FC7\u7A0B\u5C31\u662F\u9A8C\u8BC1\u670D\u52A1\u7AEF\u8BC1\u4E66\u662F\u5426\u662F\u6839\u8BC1\u4E66\u9881\u53D1\u7684\uFF09openssl verify -CAfile ca.crt server.crt</li><li>\u5BA2\u6237\u7AEF\u83B7\u53D6\u670D\u52A1\u7AEF\u8BC1\u4E66\uFF0C\u7136\u540E\u8981\u9A8C\u8BC1\u5F53\u524D\u8BF7\u6C42host\u662F\u5426\u548C\u670D\u52A1\u7AEF\u8FD4\u56DE\u7684\u8BC1\u4E66\u4E2D\u7684subjectAltName(\u5907\u7528\u540D)\u80FD\u5339\u914D\u4E0A\uFF0C\u5982\u679C\u5339\u914D\u4E0D\u4E0A\uFF0C\u5219host\u9519\u8BEF</li><li>\u9A8C\u8BC1\u901A\u8FC7\u5219\u63D0\u53D6\u670D\u52A1\u7AEF\u8BC1\u4E66\u516C\u94A5\u9A8C\u8BC1\u53D1\u9001\u8FC7\u6765\u7684\u5185\u5BB9\u3002\uFF08\u751F\u6210\u63A5\u4E0B\u6765\u7684\u5BF9\u79F0\u52A0\u5BC6\u516C\u94A5\uFF09</li><li>\u4EA4\u6362\u5BF9\u79F0\u52A0\u5BC6\u7B97\u6CD5\u7684\u516C\u94A5\u548C\u9009\u62E9\u5BF9\u79F0\u52A0\u5BC6\u7684\u7B97\u6CD5</li><li>\u4F7F\u7528\u5BF9\u79F0\u52A0\u5BC6\u7B97\u6CD5\u52A0\u5BC6\u4F20\u8F93\u5185\u5BB9</li></ol><p><strong>\u66F4\u6362\u8BC1\u4E66</strong></p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment"># \u67E5\u770B\u8BC1\u4E66\u4FE1\u606F</span>
openssl x509 -noout -text -in apiserver.crt

<span class="token comment"># \u5907\u4EFD\u8BC1\u4E66</span>
<span class="token function">cp</span> -R /etc/kubernetes/pki /etc/kubernetes/pki-backup

<span class="token comment"># \u83B7\u53D6kubadm\u7684\u914D\u7F6E\u6587\u4EF6</span>
kubectl -n kube-system get configmap kubeadm-config -o <span class="token assign-left variable">jsonpath</span><span class="token operator">=</span><span class="token string">&#39;{.data.ClusterConfiguration}&#39;</span> <span class="token operator">&gt;</span> kubeadm.yaml

<span class="token comment"># \u4FEE\u6539kubeadm.yaml,certSANs</span>

apiServer:
  certSANs:
  <span class="token comment"># \u65B0\u589EIP\uFF0C\u8FD9\u91CC\u9ED8\u8BA4\u6211\u670D\u52A1\u5668\u4E0A\u662F\u7A7A\u7684\uFF0C\u6700\u597D\u662F\u67E5\u770B\u5386\u53F2\u8BC1\u4E66\u4E2D\u7684\u8FD9\u4E9B\u5B57\u6BB5\uFF0C\u90FD\u52A0\u4E0A\u3002\u9ED8\u8BA4\u7684DNS\u662F\u52A0\u4E0A\u4E86\u3002</span>
  - <span class="token string">&quot;127.0.0.1&quot;</span>
  - <span class="token string">&quot;192.168.56.11&quot;</span>
  extraArgs:
...
networking:
  ...
  podSubnet: <span class="token number">172.30</span>.0.0/16
  serviceSubnet: <span class="token number">172.16</span>.0.0/16
scheduler: <span class="token punctuation">{</span><span class="token punctuation">}</span>


<span class="token comment"># \u5220\u9664apiserver.crt, apiserver.key\u5E76\u751F\u6210\u65B0\u7684</span>
kubeadm init phase certs apiserver --config kubeadm.yaml

<span class="token comment"># \u9ED8\u8BA4\u662F\u4F1A\u5C06dns\u81EA\u52A8\u52A0\u4E0A</span>
...
<span class="token punctuation">[</span>certs<span class="token punctuation">]</span> apiserver serving cert is signed <span class="token keyword">for</span> DNS names <span class="token punctuation">[</span>kubernetes kubernetes.default kubernetes.default.svc kubernetes.default.svc.cluster.local master1<span class="token punctuation">]</span> and IPs <span class="token punctuation">[</span><span class="token number">172.16</span>.0.1 <span class="token number">10.0</span>.2.15 <span class="token number">127.0</span>.0.1 <span class="token number">192.168</span>.56.11<span class="token punctuation">]</span>

<span class="token comment"># \u5220\u9664apiserver\u7684pod\uFF08\u4F1A\u81EA\u52A8\u91CD\u542F\uFF09</span>
kubectl -n kube-system delete pod kube-apiserver-master1

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>\u53C2\u8003</strong></p>`,49),p={href:"https://kubernetes.io/zh-cn/docs/reference/access-authn-authz/certificate-signing-requests/#request-signing-process",target:"_blank",rel:"noopener noreferrer"},m=a("\u6587\u6863"),b=a("\u8BA4\u8BC1");function k(q,g){const i=e("ExternalLinkIcon"),t=e("RouterLink");return u(),c("div",null,[v,n("ul",null,[n("li",null,[n("a",p,[m,s(i)])]),n("li",null,[s(t,{to:"/other/02-openssl.html"},{default:d(()=>[b]),_:1})])])])}var f=l(o,[["render",k],["__file","10-api-auth.html.vue"]]);export{f as default};
